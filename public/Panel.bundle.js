...
// EXTERNAL MODULE: ./src/componets/App/App.css
var App = __webpack_require__(329);
;// CONCATENATED MODULE: ./src/componets/App/App.js
...
var App_App = /*#__PURE__*/function (_React$Component) {
  ...
  function App(props) {
    ...
    _this.Authentication = new Authentication(); // If running on twitch or dev rig set shorthand, otherwise set to null
    ...
    value: function componentDidMount() {
      ...
      if (this.twitch) {
        ...
        this.twitch.configuration.onChanged(function () {
          var animal = _this2.twitch.configuration.broadcaster ? _this2.twitch.configuration.broadcaster.content : "";
          var fact = _this2.twitch.configuration.developer ? _this2.twitch.configuration.developer.content : "";
    ...
    value: function componentWillUnmount() {
      if (this.twitch) {
        this.twitch.unlisten("broadcast", function () {
          return console.log("successfuly unlistened");
        });
      }
    }
  }, {
    ...
    value: function render() {
      if (this.state.finishedLoading && this.state.animal && this.state.fact) {
        return /*#__PURE__*/react.createElement("div", {
          className: this.state.theme === "light" ? "App App-light" : "App App-dark"
        }, /*#__PURE__*/react.createElement("p", null, "Random fact about ", this.state.animal), /*#__PURE__*/react.createElement("p", null, "Did you know that: ", this.state.fact));
...
/* harmony import */ var _node_modules_css_loader_dist_cjs_js_App_css__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(572);
...
if (true) {
  ...
  return true;
    ...
    module.hot.accept(
      572,
      __WEBPACK_OUTDATED_DEPENDENCIES__ => { /* harmony import */ _node_modules_css_loader_dist_cjs_js_App_css__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(572);
(function () {
